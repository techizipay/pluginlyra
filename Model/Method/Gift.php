...
class Gift extends Micuentaweb
{
    protected $_code = \Lyranetwork\Micuentaweb\Helper\Data::METHOD_GIFT;
    protected $_formBlockType = \Lyranetwork\Micuentaweb\Block\Payment\Form\Gift::class;
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $info->setCcType($micuentawebData->getData('micuentaweb_gift_cc_type'));
