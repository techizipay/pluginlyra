...
class Fullcb extends Micuentaweb
{
    ...
    protected $_code = \Lyranetwork\Micuentaweb\Helper\Data::METHOD_FULLCB;
    protected $_formBlockType = \Lyranetwork\Micuentaweb\Block\Payment\Form\Fullcb::class;
    ...
    protected function setExtraFields($order)
    {
        ...
        if ($info->getCcType()) {
            ...
            $this->micuentawebRequest->set('payment_cards', 'FULLCB3X;FULLCB4X');
        }
    }
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $option = $micuentawebData->getData('micuentaweb_fullcb_option');
        if ($option) {
            $info->setCcType($option)->setAdditionalInformation(\Lyranetwork\Micuentaweb\Helper\Payment::FULLCB_OPTION, $option);
        }
