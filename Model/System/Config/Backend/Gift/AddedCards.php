 ...
 */
namespace Lyranetwork\Micuentaweb\Model\System\Config\Backend\Gift;

use Magento\Framework\App\Filesystem\DirectoryList;

class AddedCards extends \Lyranetwork\Micuentaweb\Model\System\Config\Backend\Serialized\ArraySerialized\ConfigArraySerialized
{
    /**
    ...
    public function beforeSave()
    {
        ...
        foreach ($value as $key => $card) {
            ...
            $uploadDir = $this->filesystem->getDirectoryWrite(DirectoryList::MEDIA)->getAbsolutePath('micuentaweb/images/cc/');
