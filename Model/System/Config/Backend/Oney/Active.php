 ...
 * This file is part of Mi Cuenta Web plugin for Magento. See COPYING.md for license details.
 *
...
namespace Lyranetwork\Micuentaweb\Model\System\Config\Backend\Oney;
...
class Active extends \Magento\Framework\App\Config\Value
{
    ...
    public function save()
    {
        ...
        if ($this->getValue() /* Submodule enabled. */) {
            ...
            $_SESSION['micuentaweb_oney_enabled'] = 'True';
        }
