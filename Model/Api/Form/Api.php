...
class Api
{
     ...
     *
     * @return array[int][Lyranetwork\Micuentaweb\Model\Api\Form\Currency]
     */
     ...
     *
     * @param string $alpha3
     * @return \Lyranetwork\Micuentaweb\Model\Api\Form\Currency|null
     */
    public static function findCurrencyByAlphaCode($alpha3)
    {
        ...
        foreach ($list as $currency) {
            /**
             * @var \Lyranetwork\Micuentaweb\Model\Api\Form\Currency $currency
             */
