...
if (! class_exists('MicuentawebResponse', false)) {
    ...
    class MicuentawebResponse
    {
         ...
         * @var string
         */
        private $algo = MicuentawebApi::ALGO_SHA1;
        ...
        /**
         * Constructor for MicuentawebResponse class.
         ...
         * @param string $algo
         */
        public function __construct($params, $ctx_mode, $key_test, $key_prod, $algo = MicuentawebApi::ALGO_SHA1)
        {
            $this->rawResponse = $params;
            $this->certificate = trim(($ctx_mode == 'PRODUCTION') ? $key_prod : $key_test);

            if (in_array($algo, MicuentawebApi::$SUPPORTED_ALGOS)) {
                $this->algo = $algo;
            }
        ...
        {
            return MicuentawebApi::sign($this->rawResponse, $this->certificate, $this->algo, $hashed);
        }
        ...
        {
            return in_array($this->transStatus, MicuentawebApi::getSuccessStatuses()) || $this->isPendingPayment();
        }
        ...
        {
            return in_array($this->transStatus, MicuentawebApi::getPendingStatuses());
        }
        ...
        {
            return in_array($this->transStatus, MicuentawebApi::getCancelledStatuses());
        }
        ...
        {
            return in_array($this->transStatus, MicuentawebApi::getToValidateStatuses());
        }
        ...
        {
            $currency = MicuentawebApi::findCurrencyByNumCode($this->get('currency'));
        ...
        public function getOutputForGateway($case = '', $extra_message = '', $original_encoding = 'UTF-8')
        {
            ...
            $encoding = in_array(strtoupper($original_encoding), MicuentawebApi::$SUPPORTED_ENCODINGS) ?
