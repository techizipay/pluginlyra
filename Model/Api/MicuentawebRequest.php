...
if (! class_exists('MicuentawebRequest', false)) {
    ...
    class MicuentawebRequest
    {
        ...
        {
            // Initialize encoding.
            $this->encoding = in_array(strtoupper($encoding), MicuentawebApi::$SUPPORTED_ENCODINGS) ?
            ...
            $timestamp = time();
            $this->set('vads_trans_id', MicuentawebApi::generateTransId($timestamp));
        ...
        {
            $this->requestParameters[$name] = new MicuentawebField($name, $label, $regex, $required, $length);
        ...
        /**
         * Generate signature from a list of MicuentawebField.
         *
         * @param array[string][MicuentawebField] $fields already filtered fields list
         * @param bool $hashed
         * @return string
         */
        private function generateSignature($fields, $hashed = true)
        {
            ...
            return MicuentawebApi::sign($params, $this->getCertificate(), $this->algo, $hashed);
        }
         ...
         *
         * @return array[string][MicuentawebField] a list of MicuentawebField
         */
