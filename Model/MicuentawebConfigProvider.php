...
class MicuentawebConfigProvider implements \Magento\Checkout\Model\ConfigProviderInterface
{
    /**
    ...
    protected function getCheckoutRedirectUrl()
    {
        ...
        return $this->urlBuilder->getUrl('micuentaweb/payment/redirect', $params);
    }
