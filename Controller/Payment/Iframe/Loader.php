 ...
 */
namespace Lyranetwork\Micuentaweb\Controller\Payment\Iframe;
...
class Loader extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->getParam('mode', false) === 'cancel') {
            ...
            $lastIncrementId = $checkout->getData('micuentaweb_last_real_id');
            ...
            if ($order->getId()) {
                ...
                $checkout->setData('micuentaweb_last_real_id', null);
