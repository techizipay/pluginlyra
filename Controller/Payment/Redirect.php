 ...
 */
namespace Lyranetwork\Micuentaweb\Controller\Payment;

use Lyranetwork\Micuentaweb\Model\OrderException;
...
class Redirect extends \Magento\Framework\App\Action\Action
{
    ...
    /**
     * @var \Lyranetwork\Micuentaweb\Controller\Processor\RedirectProcessor
     */
     ...
     * @param \Lyranetwork\Micuentaweb\Controller\Processor\RedirectProcessor $redirectProcessor
     * @param \Magento\Framework\View\Result\PageFactory $resultPageFactory
     */
    public function __construct(
        \Magento\Framework\App\Action\Context $context,
        \Magento\Sales\Model\OrderFactory $orderFactory,
        \Lyranetwork\Micuentaweb\Controller\Processor\RedirectProcessor $redirectProcessor,
    ...
    public function execute()
    {
        try {
            ...
            return $this->forward();
        } catch (\Lyranetwork\Micuentaweb\Model\OrderException $e) {
    ...
    private function getAndCheckOrder()
    {
        ...
        if ($this->getRequest()->getParam('iframe', false)) {
            $checkout->setData('micuentaweb_last_real_id', $lastIncrementId);
    ...
    private function back($msg)
    {
        ...
        if ($this->getRequest()->getParam('iframe', false)) {
            ...
            $block = $result->getLayout()
                ->createBlock(\Lyranetwork\Micuentaweb\Block\Payment\Iframe\Response::class)
                ->setTemplate('Lyranetwork_Micuentaweb::payment/iframe/response.phtml')
    ...
    private function forward()
    {
        ...
        if ($this->getRequest()->getParam('iframe', false)) {
            $resultPage->addHandle('micuentaweb_payment_iframe_redirect');
        } else {
            $resultPage->addHandle('micuentaweb_payment_form_redirect');
