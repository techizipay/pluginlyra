...
class Response extends \Magento\Framework\App\Action\Action
{
    ...
    /**
     * @var \Lyranetwork\Micuentaweb\Controller\Processor\ResponseProcessor
     */
        ...
        if ($this->dataHelper->getCommonConfigData('ctx_mode', $storeId) === 'TEST') {
            ...
            if ($checkUrlWarn) {
                ...
                if ($this->dataHelper->isMaintenanceMode()) {
                    ...
                    $message = __('The automatic validation has not worked. Have you correctly set up the notification URL in your Mi Cuenta Web Back Office?');
                    $message .= '&nbsp;';
