 ...
 */
namespace Lyranetwork\Micuentaweb\Controller\Adminhtml\System\Config;
...
class Reset extends \Magento\Backend\App\AbstractAction
{
    ...
    public function execute()
    {
        ...
        $where = [];
        $where[] = $connection->quoteInto('path REGEXP ?', '^payment/micuentaweb_[a-z0-9]+/[a-z0-9_]+$');
        $where[] = $connection->quoteInto('path REGEXP ?', '^micuentaweb/general/[a-z0-9_]+$');
        ...
        $this->messageManager->addSuccessMessage(
            __('The configuration of the Mi Cuenta Web module has been successfully reset.')
        );
