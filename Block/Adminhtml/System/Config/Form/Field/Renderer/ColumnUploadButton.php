 ...
 */
namespace Lyranetwork\Micuentaweb\Block\Adminhtml\System\Config\Form\Field\Renderer;
...
class ColumnUploadButton extends \Magento\Framework\View\Element\AbstractBlock
{
    ...
    protected function _toHtml()
    {
        ...
        $src = $store->getBaseUrl(UrlInterface::URL_TYPE_MEDIA) . "micuentaweb/images/cc/$image?" . time();
