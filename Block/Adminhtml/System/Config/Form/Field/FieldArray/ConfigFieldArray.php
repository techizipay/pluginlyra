 ...
 */
namespace Lyranetwork\Micuentaweb\Block\Adminhtml\System\Config\Form\Field\FieldArray;
...
abstract class ConfigFieldArray extends \Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray
{
    ...
    {
        if ($this->staticTable) {
            $this->_template = 'Lyranetwork_Micuentaweb::system/config/form/field/static_array.phtml';
        }
    ...
    protected function getLabelRenderer($columnName)
    {
        if (! isset($this->$columnName) || ! $this->$columnName) {
            $this->$columnName = $this->getLayout()->createBlock(
                \Lyranetwork\Micuentaweb\Block\Adminhtml\System\Config\Form\Field\Renderer\ColumnLabel::class,
                '',
                [
                    'data' => [
    ...
    protected function getListRenderer($columnName, $options)
    {
        if (! isset($this->$columnName) || ! $this->$columnName) {
            $this->$columnName = $this->getLayout()->createBlock(
                \Lyranetwork\Micuentaweb\Block\Adminhtml\System\Config\Form\Field\Renderer\ColumnList::class,
                '',
                [
                    'data' => [
                        'is_render_to_js_template' => false,
    ...
    protected function getUploadButtonRenderer($columnName)
    {
        if (! isset($this->$columnName) || ! $this->$columnName) {
            $this->$columnName = $this->getLayout()->createBlock(
                \Lyranetwork\Micuentaweb\Block\Adminhtml\System\Config\Form\Field\Renderer\ColumnUploadButton::class,
                '',
                [
                    'data' => [
                        'is_render_to_js_template' => false
    ...
    protected function getMultiselectRenderer($columnName, $options)
    {
        if (! isset($this->$columnName) || ! $this->$columnName) {
            $this->$columnName = $this->getLayout()->createBlock(
                \Lyranetwork\Micuentaweb\Block\Adminhtml\System\Config\Form\Field\Renderer\ColumnMultiselect::class,
                '',
                [
                    'data' => [
                        'is_render_to_js_template' => false,
