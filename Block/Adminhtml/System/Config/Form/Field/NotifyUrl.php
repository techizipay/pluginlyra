...
{
    /**
     * @param \Lyranetwork\Micuentaweb\Block\Adminhtml\System\Config\Form\Field\Context $context
     * @param array $data
     */
    public function __construct(
        \Lyranetwork\Micuentaweb\Block\Adminhtml\System\Config\Form\Field\Context $context,
        array $data = []
    ) {
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        if (strpos($element->getComment(), '<img') === false) {
            $warnImg = $this->getViewFileUrl('Lyranetwork_Micuentaweb::images/warn.png');
