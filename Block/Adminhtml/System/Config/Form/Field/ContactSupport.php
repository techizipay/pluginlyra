...
class ContactSupport extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _prepareLayout()
    {
        ...
        if (! $this->getTemplate()) {
            $this->setTemplate('Lyranetwork_Micuentaweb::system/config/form/field/contact_support.phtml');
        }
    ...
    {
        return $this->getUrl('micuentaweb/system_config/support', ['_nosid' => true]);
    }
}
