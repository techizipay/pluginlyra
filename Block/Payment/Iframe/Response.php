 ...
 */
namespace Lyranetwork\Micuentaweb\Block\Payment\Iframe;
...
class Response extends \Magento\Framework\View\Element\Template
{
     ...
     * @param string $path
     * @param string $params
     * @return \Lyranetwork\Micuentaweb\Block\Payment\Iframe\Response
     */
    ...
    public function getLoaderHtml()
    {
        $block = $this->getLayout()
            ...
            ->setTemplate('Lyranetwork_Micuentaweb::payment/iframe/loader.phtml');
